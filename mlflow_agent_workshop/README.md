...
The 'mlflow_agent_workshop' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/mlflow_agent_workshop/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] mlflow_agent_workshop_etl` to your workspace.
